...
export default function DoubleDeckerPage() {
  ...
  const handleExcelExport = () => {
    try {
      ...
      XLSX.utils.book_append_sheet(wb, ws, "Double Decker Vehicles");
      
      // Write workbook and trigger download
      XLSX.writeFile(wb, `Double_Decker_Vehicles_${new Date().toISOString().split('T')[0]}.xlsx`);
    } catch (err) {
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center">
                <Logo />
                <div className="ml-4">
                  <h1 className="text-2xl font-bold text-white">DOUBLE DECKER VEHICLE</h1>
                  <p className="text-gray-400">Monitor and manage your DOUBLE DECKER VEHICLE fleet operations</p>
                </div>
              </div>
