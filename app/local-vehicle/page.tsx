...
export default function LocalVehiclePage() {
  ...
  const handleExcelExport = () => {
    try {
      ...
      XLSX.utils.book_append_sheet(wb, ws, "Local Vehicles");
      
      // Write workbook and trigger download
      XLSX.writeFile(wb, `Local_Vehicles_${new Date().toISOString().split('T')[0]}.xlsx`);
    } catch (err) {
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center">
                <Logo />
                <div className="ml-4">
                  <h1 className="text-2xl font-bold text-white">LOCAL VEHICLE</h1>
                  <p className="text-gray-400">Monitor and manage your LOCAL VEHICLE fleet operations</p>
                </div>
              </div>
