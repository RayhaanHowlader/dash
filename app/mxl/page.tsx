...
export default function MXLPage() {
  ...
  // Memoized filtering for place and date (like SXL)
  ...
  // Set table font size to a fixed 20px for all rows
  useEffect(() => {
    setTableFontSize(20);
    // Optionally, keep row height dynamic if you want, or set a fixed value as well
    const totalRows =
        ...
        <header className="header-container" style={{
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center">
                <Logo />
                <div className="ml-4">
                <h1 className="text-3xl font-bold text-white tracking-wide">MXL VEHICLE</h1>
                <p className="text-gray-400 text-sm">Monitor and manage your MXL VEHICLE fleet operations</p>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
              ...
              <Button
                variant="primary"
                onClick={() => handleExport(vehicles, 'MXL Vehicles')}
